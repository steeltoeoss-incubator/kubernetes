...
namespace System.Linq
{
    ...
    internal abstract partial class AsyncIteratorBase<TSource> : IAsyncEnumerable<TSource>, IAsyncEnumerator<TSource>
    {
        ...
        protected volatile InformableIteratorState _state = InformableIteratorState.New;
        ...
        public IAsyncEnumerator<TSource> GetAsyncEnumerator(CancellationToken cancellationToken)
        {
            ...
            var enumerator = _state == InformableIteratorState.New && _threadId == Environment.CurrentManagedThreadId
                ? this
                : Clone();

            enumerator._state = InformableIteratorState.Allocated;
        ...
        {
            _state = InformableIteratorState.Disposed;
    ...
    internal enum InformableIteratorState
    {
        New,
        Allocated,
        ResetStart,
